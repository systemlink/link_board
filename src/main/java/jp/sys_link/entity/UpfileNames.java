...
public class UpfileNames {
    ...
    /**
     * billboardsのプロパティ名を返します。
     * 
     * @return billboardsのプロパティ名
     */
    public static _BillboardsNames billboards() {
        return new _BillboardsNames("billboards");
    }
    ...
    public static class _UpfileNames extends PropertyName<Upfile> {
         ...
         * @return billboardsのプロパティ名
         */
        public _BillboardsNames billboards() {
            return new _BillboardsNames(this, "billboards");
        }
    }
}